 ...
 * @description Compared to {@linkcode implementWorker}, {@linkcode implementWorkerExternal} covers the following
 ...
 * Said script must call {@linkcode serve} passing a function and export the type of said function, which is then passed
 * to {@linkcode implementWorkerExternal}.
 ...
 * @typeParam T The type of the served function. {@linkcode KissWorker.execute} will have an equivalent signature. NOTE:
 * The caller **must** pass an argument for this parameter, otherwise the argument for `createWorker` will not be
 * accepted.
 */
