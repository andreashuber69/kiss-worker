...
import type { getObjectInfo, ObjectInfo } from "./getObjectInfo.js";
 ...
 * Said script must call {@linkcode serveObject} passing a constructor function and export an object obtained through
 * {@linkcode getObjectInfo}, which is then passed to this function.
